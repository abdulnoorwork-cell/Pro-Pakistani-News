...
const Signin = () => {
  ...
  return loginModel ? (
    <div className='min-h-[86vh] h-full content-center justify-center bg-[#249991] py-8'>
      <div className='container mx-auto px-3'>
        <form onSubmit={onLoginHandler} className='bg-white rounded-[10px] text-sm p-[40px] shadow-[0px_5px_25px_0px_rgba(0,0,0,0.1)] max-w-[700px] mx-auto'>
          ...
          <div className='my-7 flex flex-col gap-3'>
            <div>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className='bg-[#ECF2F7] rounded-[5px] text-[#3D3D3D] placeholder:text-gray-400 py-[13px] px-[16px] text-sm w-full outline-[#1fb6ac]' placeholder='Email' style={{ fontFamily: 'Urbanist' }} />
            ...
            <div>
              ...
              <div className='flex items-center justify-between w-full outline-[#1fb6ac] bg-[#ECF2F7] rounded-[5px] pr-4'>
            ...
            <p onClick={() => navigate('/forgot-password')} className='text-[#249991] font-medium cursor-pointer' style={{ fontFamily: 'Urbanist' }}>Forgot Password?</p>
          </div>
          <button type='submit' className='bg-[#1fb6ac] text-[#111827] font-medium cursor-pointer text-sm py-3 px-12 rounded-full w-fit' style={{ fontFamily: 'Urbanist' }}>{loading ? 'loading...' : 'Signin'}</button>
          <p className='text-gray-800 mt-4 font-medium' style={{ fontFamily: 'Urbanist' }}>Don,t have an account? <Link onClick={() => { setSignupModel(true); setLoginModel(false) }} className='text-[#249991] font-medium' style={{ fontFamily: 'Urbanist' }}>Signup</Link></p>
        </form>
      </div>
    </div>
  ) : (
    <div className='content-center justify-center min-h-[86vh] h-full bg-[#249991] py-8'>
      <div className='container mx-auto px-3'>
        <form onSubmit={onSignupHandler} className='bg-white rounded-[10px] text-sm p-[40px] shadow-[0px_5px_25px_0px_rgba(0,0,0,0.1)] max-w-[700px] mx-auto'>
          ...
          <div className='my-7 flex flex-col gap-3'>
            <div>
              ...
              <input value={name} onChange={(e) => setName(e.target.value)} type="text" className='bg-[#ECF2F7] rounded-[5px] text-[#3D3D3D] placeholder:text-gray-400 py-[13px] px-[16px] text-sm w-full outline-[#1fb6ac]' placeholder='Name' style={{ fontFamily: 'Urbanist' }} />
            ...
            <div>
              ...
              <input value={phone} onChange={(e) => setPhone(e.target.value)} type="number" className='bg-[#ECF2F7] rounded-[5px] text-[#3D3D3D] placeholder:text-gray-400 py-[13px] px-[16px] text-sm w-full outline-[#1fb6ac]' placeholder='Phone' style={{ fontFamily: 'Urbanist' }} />
            </div>
            <select onChange={(e)=>setRole(e.target.value)} className='bg-[#ECF2F7] rounded-[5px] text-[#3D3D3D] placeholder:text-gray-400 py-[11px] px-3 text-sm outline-[#1fb6ac] w-[150px] mt-3' defaultValue={1}>
          ...
          <button type='submit' className='bg-[#1fb6ac] text-[#111827] cursor-pointer font-medium text-sm py-3 px-12 rounded-full w-fit' style={{ fontFamily: 'Urbanist' }}>{loading ? 'loading...' : 'Sign Up'}</button>
